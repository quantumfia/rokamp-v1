            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex-1 flex items-center justify-end px-3 py-2">
                <button
                  ...
                  className="flex items-center gap-0.5 text-[10px] text-muted-foreground hover:text-foreground transition-colors translate-y-[2px]"
                >
                  전체보기
            ...
            <div ref={contentScrollRef} className="flex-1 overflow-y-scroll">
              ...
              {selectedNotice.attachments && selectedNotice.attachments.length > 0 && (
                <div className="px-5 py-3 border-t border-border">
                  <div className="text-[10px] text-muted-foreground mb-2 uppercase tracking-wider">첨부파일</div>
                  <div className="space-y-1.5">
                    {selectedNotice.attachments.map((attachment) => (
                      <button
                        key={attachment.id}
                        onClick={() => handleDownload(attachment)}
                        className="w-full flex items-center gap-2 px-3 py-2 bg-muted/50 hover:bg-muted rounded transition-colors text-left group"
                      >
