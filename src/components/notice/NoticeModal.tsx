...
export function NoticeModal({ onClose }: NoticeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      {/* Modal - Fixed size */}
      <div className="relative w-full max-w-3xl h-[530px] min-h-[530px] max-h-[530px] bg-background border border-border shadow-2xl overflow-hidden flex flex-col">
        {/* Header Bar */}
            ...
            <div className="flex-1 overflow-hidden flex flex-col">
              {filteredNotices.map((notice) => (
                <button
                  ...
                  className={cn(
                    "w-full text-left px-3 py-2 border-b border-border/50 last:border-b-0 transition-colors",
                    filteredNotices.length === 5 && "flex-1",
                    filteredNotices.length === 5 && "flex flex-col justify-center",
